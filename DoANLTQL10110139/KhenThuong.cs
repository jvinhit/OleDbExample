...
{
    public partial class KhenThuong : DevComponents.DotNetBar.Office2007Form
    {
        public KhenThuong()
        {
            InitializeComponent();
        ...
        {
            subCreateConnect();
            string sqlstringcc = "Select SinhVien.Masv, SinhVien.Hodem, SinhVien.Ten, KhenThuong.HocBong,KhenThuong.Khoankhac, Khenthuong.Tongtien From SinhVien, KhenThuong Where SinhVien.Masv= KhenThuong.Masv";
            ...
            dgvKhenThuong.DataSource = objDataTable;
            objCommand.Dispose();
            objCommand = null;
            objReader.Close();
            objReader.Dispose();
